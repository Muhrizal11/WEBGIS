      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4 col-md-offset-4">
            ...
            <h4 class="white">Sistem Informasi Geografis Objek Wisata</h4>
          ...
          <h5 class="white">Copyright &copy; Muh. Rizal 2022</h5>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <h4>NAMA    : MUH  RIZAL</h4>
        <h4>ASAL    : KALIMANTAN UTARA</h4>
        <h4>TTL     : TRENGGALEK, 05 MEI 2001</h4>
      </div>
    </div>
  </div>
</div>
